  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/dashboard" class="nav-link">Company Name</a>
      </li>
    </ul>
      ...
      <nav class="mt-2" >
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('advantages.index')}}" class="nav-link {{ Request::segment(2) =='advantages' ? 'active' : ''}} ">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('service.index')}}" class="nav-link {{ Request::segment(2) =='service' ? 'active' : ''}} ">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('team.index')}}" class="nav-link {{ Request::segment(2) =='team' ? 'active' : ''}} ">
                  <i class="fa fa-users"></i>
                   <p>Jamoa</p>
                </a>
              </li>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('slider.index')}}" class="nav-link {{ Request::segment(2) =='slider' ? 'active' : ''}} ">
