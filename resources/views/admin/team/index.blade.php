...
@section('content')
<div class="container">
	<div class="col-md-12"> <a href="{{route('team.create')}}" class="btn btn-primary"> Create</a>
		<div class="card">
			<div class="card-body">
							...
							<table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
								<thead>
									<tr role="row">
										...
										<th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="">lavozimi </th>
										<th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style=""> rasmi </th>
								...
								<tbody> 
									...
									<tr class="odd">
										...
										<td><a href="{{route('team.edit', $item->id)}}" class="btn btn-success">Edit</a>
											<br>
											<br>
